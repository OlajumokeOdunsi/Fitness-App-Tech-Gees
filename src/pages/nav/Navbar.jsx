...
const Navbar = () => {
    ...
    const content = [
        <>
            <div className="lg:hidden block absolute top-20 w-full left-0 right-0 bg-logo-color transition">
                <ul className="text-xl p-16 pt-4">
                    ...
                    <Link spy={true} smooth={true} to="Join">
                        <button className='mt-4 cursor-pointer bg-text-color p-4 rounded-xl hover:bg-bg-color hover:text-text-color font-bold'>Join Now → </button>
                    </Link>
    ...
    return (
        ...
        <nav className="main-font">
            <div className="w-full fixed h-30 flex gap-20 items-center justify-betwee lg:py-5 px-10 py-8 bg-logo-color  text-white">

                <div className="flex">

                    <div className='flex items-center justify-center gap-1'>
                        <img className='w-8 h-8' src={logo} alt="" />
                        <h3 className="text-md font-extrabold tracking-[.1rem]">Vitality <br /><span className='text-[0.9rem] text-bg-color ' >Fitness</span></h3>
                    </div>
                </div>
